...
Since $i = \sqrt{-1}$ and is a root to the equation $x^2 + 1 = 0$, we can define complex roots of polynomials that do not have real roots. This gives rise to the following theorem which we will revisit later:

\begin{thmbox}[Fundamental Theorem of Algebra]
   Let $p(x) := a_0 + a_1x + \dots + a_nx^n$ be a nonconstant polynomial over $\CC$, i.e. $a_0, \dots, a_n \in \CC$, $n \geq 1$ and $a_n \neq 0$. Then $p(x)$ has at least one root in $\CC$.
\end{thmbox}
